...
func GetConfigPath(name string, filename string) string {
	...
	// Android/embedded override: the host app points this at a writable
	// directory (its files dir) so state does not land in the read-only
	// native library directory.
	if base := os.Getenv("BF_CONFIG_HOME"); base != "" {
